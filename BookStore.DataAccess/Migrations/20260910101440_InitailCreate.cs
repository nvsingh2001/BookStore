        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityToBuy = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Admin_Phone_Unique",
                table: "Admins",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_CartItem_UserId_ProductId_Unique",
                table: "CartItems",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Feedback_UserId_ProductId_Unique",
                table: "Feedbacks",
                columns: new[] { "UserId", "ProductId" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_User_Phone_Unique",
                table: "Users",
                column: "Phone",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_WishlistItem_UserId_ProductId_Unique",
                table: "WishlistItems",
                columns: new[] { "UserId", "ProductId" },
                unique: true);
